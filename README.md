...
😊 **손지은 장군**: 첫 번째 프로젝트를 진행하면서 수업시간에 배운 Python, MySQL, 웹 크롤링, Streamlit 내용을 하나의 주제 안에서 직접 적용해볼 수 있어 정말 의미 있는 시간이었습니다. 단순히 개념을 배우는 데서 끝나는 것이 아니라, 실제 데이터 수집부터 정리, 분석, 구현까지 연결해보며 이해를 더 깊게 할 수 있었습니다. 특히 좋은 팀원들과 함께 의견을 나누고 역할을 분담하며 협업의 중요성도 많이 배울 수 있어 좋았습니다. 이번 프로젝트를 통해 실무형 프로젝트가 어떻게 진행되는지 경험할 수 있었고, 앞으로 더 발전하고 싶다는 동기부여도 얻었습니다.
