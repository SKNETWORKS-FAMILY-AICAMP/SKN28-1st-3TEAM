...
| 지역별 전기차 등록 현황을 한눈에 확인할 수 있는 메인 분석 화면입니다.
비교 지역과 차트 기간을 선택해 주요 지표를 빠르게 파악할 수 있습니다. |
...
| 뉴스 데이터 기반 핵심 키워드를 워드클라우드로 시각화한 화면입니다.
주요 이슈를 직관적으로 확인하고 전체 뉴스 흐름을 한눈에 이해할 수 있습니다. |
